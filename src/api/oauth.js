...
const clientId = process?.env?.clientId || '0371f7b90f2541959c40240e54a384c3'
const clientSecret = process?.env?.clientSecret || 'Ho5Vf6sJxlJRFniu983GaqMVIN9DXUJW'
...
function getToken () {
  ...
  // En este objeto llamado 'config' vamos a insertar algunos parámetros de
  // configuración que necesitamos para hacer la llamada.
  const config = {
